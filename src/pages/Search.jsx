...
import { handleImageError, handleArtistImageError, handleAlbumImageError, handlePlaylistImageError } from '../utils/imageUtils';
...
const Search = () => {
  ...
  return (
    <div className="text-white pb-20">
      <div className="sticky top-0 z-10 bg-[#121212] pt-4 pb-6 px-8">
        <input
          type="text"
